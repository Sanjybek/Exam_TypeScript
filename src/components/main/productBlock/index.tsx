...
const ProductBlock: React.FC<ProductsType> = ({
    ...
    return (
        <>
                ...
                <button type="button" onClick={() => edit(product.id)} className={s.home__btn_edit}>Редактировать</button>
                <button onClick={() => addToCart(product.id)} className={s.home__btn_bascet}>Добавить в корзину</button>
            </div>
